...
"""
All the added sugar elements will be gathered here.
...
items = {'keywords':['jam', 'jams', 'jelly', 'jellies', 'jellied', 'canned fruit', 'sweets', 'syrups', 'ice cream'],
...
DIABETES_CATEGORY = {'label': 'Added Sugars', 
                    'id':create_uuid_from_string('Added Sugars'),
                    ...
                    'description':"""When it comes to fruit and diabetes, it's best to avoid fruit with added sugar. The most likely culprits for this 
                    are dried and canned fruit and fruit products like jams and jellies. The best way to know whether the fruit product contains added sugar 
                    is by looking at the ingredient label. Source:https://www.verywellhealth.com/type-2-diabetes-food-6744460 """
                    }
...
for item in usfda_data:
    ...
    guideline_res = guidelines.check_added_sugar(nutrition_formatted)
    if guideline_res['tag'] == 'high sugar': 
...
json.dump(final_data, open('../result_data/added_sugars.json', 'w'))
print(("File saved"))
