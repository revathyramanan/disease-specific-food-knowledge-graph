...
DIABETES_CATEGORY = {'label': 'High Fats', 
                    'id':create_uuid_from_string('High Fats'),
                    ...
                    'example_items':{},
                    'description':"""Due to increased association with heart disease, high fat items are suggested to be avoided for diabetes as well. Source:https://www.healthline.com/health/diabetes/how-much-fat-can-a-diabetic-have-a-day#nutrition-labels
...
json.dump(final_data, open('../result_data/high_fats.json', 'w'))
print(("File saved"))
