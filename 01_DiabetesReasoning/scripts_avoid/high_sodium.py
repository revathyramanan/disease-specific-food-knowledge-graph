...
DIABETES_CATEGORY = {'label': 'High Sodium', 
                    'id':create_uuid_from_string('High Sodium'),
...
for item in usfda_data:
    ...
    if guideline_res['tag'] == 'high sodium': 
        tag_counter += 1
...
json.dump(final_data, open('../result_data/high_sodium.json', 'w'))
print(("File saved"))
